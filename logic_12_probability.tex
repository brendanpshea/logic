...
\frametitle{Discussion: The Ethics of Algorithmic Bias}
  ...
  \begin{itemize}
    ...
    \item This can result in models that are both inefficient (bad for business) and unjust (bad for society).
  \end{itemize}
  ...
  \begin{block}{Discussion: Challenging Fair Probabilities}
    ...
    \begin{enumerate}
        ...
        \item Many argue for "explainable AI" to understand decisions. For example, if I am denied a loan (or a job, or insurance), should I be told the exact probabilities (and the data used to arrive at these) used in the decision?
    \end{enumerate}
  \end{block}
